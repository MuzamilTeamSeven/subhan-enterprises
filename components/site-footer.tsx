...
const socials = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/SubhanEnterprise/",
    path: "M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12Z",
  },
  {
    label: "Instagram",
    href: "https://www.instagram.com/subhan._enterprises/",
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@Subhan-Enterprises",
    path: "M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814ZM9.545 15.568V8.432L15.818 12l-6.273 3.568Z",
  },
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@subhan_enterprises",
  ...
  return (
    <footer className="relative mt-6 border-t border-border px-3 pb-8 pt-12 sm:px-6">
      ...
      <div className="mx-auto mt-10 flex max-w-7xl flex-col items-center justify-between gap-3 border-t border-border pt-6 text-xs text-muted-foreground sm:flex-row">
        <p>© 2025 Subhan Enterprises. All Rights Reserved.</p>
      ...
      <a
        ...
        className="whatsapp-float fixed bottom-6 right-6 z-50 flex flex-col items-center gap-1"
        aria-label="Chat on WhatsApp"
      >
        {/* "Chat with us" label */}
        <span className="whatsapp-label rounded-full bg-white px-3 py-1 text-[11px] font-semibold text-[#25D366] shadow-lg">
          Chat with us
        </span>
        {/* Icon button */}
        <span className="whatsapp-icon-btn flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white">
