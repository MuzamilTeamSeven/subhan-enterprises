...
export function ContactForm() {
    ...
    return (
      <div className="glass-tint flex flex-col items-center gap-3 rounded-2xl px-6 py-16 text-center">
        ...
        <button
          ...
          className="mt-2 rounded-xl border border-border px-4 py-2 text-sm font-medium text-muted-foreground transition hover:border-primary hover:text-primary"
        >
  ...
  const inputClass =
    "glass rounded-xl px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:border-primary focus:outline-none"
  ...
  return (
    <form onSubmit={handleSubmit} className="grid gap-3">
      ...
      <button
        type="submit"
        className="mt-1 flex items-center justify-center gap-2 rounded-xl bg-primary px-6 py-3.5 text-sm font-semibold text-primary-foreground transition hover:brightness-110"
      >
